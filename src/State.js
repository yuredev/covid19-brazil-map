...
class State {
  ...
  setStyle() {
    if (this.confirmedCases > 100000) {
      this.radius = 400000;
      this.color = 'rgb(90, 0, 40)';
      this.fillColor = "rgb(100, 0, 30)";
    } else if (this.confirmedCases > 80000) {
      this.radius = 360000;
      this.color = 'rgb(100, 0, 30)';
      this.fillColor = "rgb(100, 0, 30)";
    } else if (this.confirmedCases > 60000) {
      this.radius = 310000;
      this.color = 'rgb(120, 0, 20)';
      this.fillColor = "rgb(120, 0, 20)";
    } else if (this.confirmedCases > 50000) {
      this.radius = 290000;
      this.color = 'rgb(150, 0, 10)';
      this.fillColor = "rgb(150, 0, 10)";
    } else if (this.confirmedCases > 40000) {
      this.radius = 250000;
      this.color = 'rgb(150, 0, 10)';
      this.fillColor = "rgb(150, 0, 10)";
    } else if (this.confirmedCases > 35000) {
      this.radius = 200000;
      this.color = 'rgb(170, 0, 0)';
      this.fillColor = "rgb(170, 0, 0)";
    } else if (this.confirmedCases > 25000) {
      this.radius = 150000;
